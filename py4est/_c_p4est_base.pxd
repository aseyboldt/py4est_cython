...
cdef extern from "p4est_base.h" nogil:
    ...
    void P4EST_GLOBAL_LOGF (int priority, char *fmt, ...)
    void P4EST_LOGF (int priority, char *fmt, ...)
    void P4EST_GLOBAL_TRACEF (char *fmt, ...)
    void P4EST_GLOBAL_LDEBUGF (char *fmt, ...)
    void P4EST_GLOBAL_VERBOSEF (char *fmt, ...)
    void P4EST_GLOBAL_INFOF (char *fmt, ...)
    void P4EST_GLOBAL_STATISTICSF (char *fmt, ...)
    void P4EST_GLOBAL_PRODUCTIONF (char *fmt, ...)
    void P4EST_GLOBAL_ESSENTIALF (char *fmt, ...)
    void P4EST_GLOBAL_LERRORF (char *fmt, ...)
    void P4EST_TRACEF (char *fmt, ...)
    void P4EST_LDEBUGF (char *fmt, ...)
    void P4EST_VERBOSEF (char *fmt, ...)
    void P4EST_INFOF (char *fmt, ...)
    void P4EST_STATISTICSF (char *fmt, ...)
    void P4EST_PRODUCTIONF (char *fmt, ...)
    void P4EST_ESSENTIALF (char *fmt, ...)
    void P4EST_LERRORF (char *fmt, ...)
